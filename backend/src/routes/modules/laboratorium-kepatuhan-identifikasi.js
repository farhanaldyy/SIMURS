...
const ctrl = require('../../controllers/modules/laboratorium-kepatuhan-identifikasi.controller');
...
router.post('/', [
  ...
  body('jumlah_kepatuhan').isInt({ min: 0 }).withMessage('Jumlah kepatuhan wajib berupa angka'),
