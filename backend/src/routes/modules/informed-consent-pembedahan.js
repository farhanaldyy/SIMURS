...
const ctrl = require('../../controllers/modules/informed-consent-pembedahan.controller');

router.use(verifyToken);

router.get('/', (req, res, next) => { req.query.jenis = 'pembedahan'; next(); }, ctrl.getAll);
router.get('/summary', (req, res, next) => { req.query.jenis = 'pembedahan'; next(); }, ctrl.getSummary);
