...
const ctrl = require('../../controllers/modules/angka-kematian-igd.controller');

router.use(verifyToken);

router.get('/', (req, res, next) => { req.query.lokasi = 'igd'; next(); }, ctrl.getAll);
router.get('/summary', (req, res, next) => { req.query.lokasi = 'igd'; next(); }, ctrl.getSummary);
