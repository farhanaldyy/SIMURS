...
const ctrl = require('../../controllers/modules/surgical-checklist-sc.controller');

router.use(verifyToken);

router.get('/', (req, res, next) => { req.query.jenis = 'sc'; next(); }, ctrl.getAll);
router.get('/summary', (req, res, next) => { req.query.jenis = 'sc'; next(); }, ctrl.getSummary);
