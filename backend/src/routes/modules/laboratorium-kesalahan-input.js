...
const ctrl = require('../../controllers/modules/laboratorium-kesalahan-input.controller');
...
router.post('/', [
  ...
  body('jumlah_kesalahan').isInt({ min: 0 }).withMessage('Jumlah kesalahan wajib berupa angka'),
