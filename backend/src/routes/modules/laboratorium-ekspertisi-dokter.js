...
const ctrl = require('../../controllers/modules/laboratorium-ekspertisi-dokter.controller');
...
router.post('/', [
  ...
  body('ekspertisi_dokter').isInt({ min: 0 }).withMessage('Ekspertisi dokter wajib berupa angka'),
