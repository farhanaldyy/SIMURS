...
const ctrl = require('../../controllers/modules/informed-consent-anestesi.controller');

router.use(verifyToken);

router.get('/', (req, res, next) => { req.query.jenis = 'anestesi'; next(); }, ctrl.getAll);
router.get('/summary', (req, res, next) => { req.query.jenis = 'anestesi'; next(); }, ctrl.getSummary);
