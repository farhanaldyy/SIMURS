...
const ctrl = require('../../controllers/modules/gizi-sisa-makanan.controller');
...
router.post('/', [
  ...
  body('jumlah_sisa').isInt({ min: 0 }).withMessage('Jumlah sisa makanan harus berupa angka non-negatif'),
...
router.put('/:id', [
  ...
  body('jumlah_sisa').optional().isInt({ min: 0 }).withMessage('Jumlah sisa makanan harus berupa angka non-negatif'),
