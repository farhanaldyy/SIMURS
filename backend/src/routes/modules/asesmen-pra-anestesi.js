...
const ctrl = require('../../controllers/modules/asesmen-pra-anestesi.controller');

router.use(verifyToken);

router.get('/', (req, res, next) => { req.query.jenis = 'pra_anestesi'; next(); }, ctrl.getAll);
router.get('/summary', (req, res, next) => { req.query.jenis = 'pra_anestesi'; next(); }, ctrl.getSummary);
