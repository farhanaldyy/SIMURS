...
export default createGenericIndicatorPage({
  title: 'Asesmen Pra Anestesi',
  subtitle: 'Kepatuhan kelengkapan pengisian asesmen pra anestesi sebelum tindakan operasi',
  endpoint: '/asesmen-pra-anestesi',
  metricType: 'compliance',
  columns: [
    { label: 'Nama Pasien', key: 'nama_pasien' },
    { label: 'No RM', key: 'no_rm' },
    { label: 'DPJP Anestesi', key: 'dpjp' },
  ...
  fields: [
    ...
    { name: 'dpjp', label: 'DPJP Anestesi', type: 'text', required: true, row: 2 },
